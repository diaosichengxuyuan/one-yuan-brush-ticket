...
public class MemberServiceImpl implements MemberService {
    ...
    public MemberDTO queryMember(String accountId) {
        ...
        return MemberDTO.builder().accountId(memberDO.getAccountId()).periodValidity(DateUtil.formatDate(memberDO.getPeriodValidity(),"yyyy-MM-dd HH:mm:ss"))
            .isMember(memberDO.getPeriodValidity().after(new Date())).build();
    }
